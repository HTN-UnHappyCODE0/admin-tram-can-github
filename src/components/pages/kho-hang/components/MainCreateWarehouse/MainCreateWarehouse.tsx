...
import styles from './MainCreateWarehouse.module.scss';
...
function MainCreateWarehouse({}: PropsMainCreateWarehouse) {
	...
	const [form, setForm] = useState<IFormCreateWarehouse>({
		name: '',
		address: '',
		scaleStationUuid: '',
		provinceId: '',
		...
		<div className={styles.container}>
			...
			<Form form={form} setForm={setForm} onSubmit={handleSubmit}>
				...
				<div className={styles.form}>
					...
					<div className={clsx('mt')}>
						<TextArea name='description' placeholder='Nhập ghi chú' label={<span>Ghi chú</span>} max={5000} blur={true} />
					</div>
				</div>
			</Form>
		</div>
...
export default MainCreateWarehouse;
