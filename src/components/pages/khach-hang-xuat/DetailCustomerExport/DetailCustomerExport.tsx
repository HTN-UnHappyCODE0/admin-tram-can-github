		...
		<Fragment>
			...
			<div className={styles.header}>
				...
				>
					...
					<p>Chi tiết khách hàng xuất: {detailPartner?.name}</p>
				</Link>
				<div className={styles.list_btn}>
					<Button
						...
						p_8_16
						bold
						href={`/khach-hang-xuat/chinh-sua?_id=${detailPartner?.uuid}`}
			...
			<div className={clsx('mt')}>
				<div className={styles.btn_header}>
					...
					<div>
						<Button
							href={`${PATH.ThemMoiXuong}?_partnerUuid=${_id}&_typeCus=${TYPE_PARTNER.KH_XUAT}`}
							p_8_16
							rounded_2
