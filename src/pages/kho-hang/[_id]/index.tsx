...
import DetailStorage from '~/components/pages/kho-hang/components/PageDetailWarehouse/DetailStorage';
import DetailWarehouse from '~/components/pages/kho-hang/components/PageDetailWarehouse/DetailWarehouse';
